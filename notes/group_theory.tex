...
\section{Nebenklassen \& Satz von Lagrange}
...
\section{Normalteiler \& Quotientengruppen}
...
\begin{remark}
  ...
  \[
    ...
    \defined  gN
  \]
  ein Gruppenhomomorphismus ist, der die folgende universelle Eigenschaft besitzt:
\end{remark}
...
\section{\texorpdfstring{$p$}{p}-Gruppen \& Sylowsätze}
